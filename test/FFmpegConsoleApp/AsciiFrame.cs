    ...
    public class AsciiFrame
    {
        ...
        public void GotRawImage(ref RawImage rawImage)
        {
                ...
                || Console.WindowHeight != grayConverter.SourceWidth)
            {
                ...
                grayConverter = new VideoFrameConverter(rawImage.Width, rawImage.Height, AVPixelFormat.AV_PIX_FMT_RGB24, Console.WindowWidth, Console.WindowHeight, FFmpeg.AutoGen.AVPixelFormat.AV_PIX_FMT_GRAY8);
            }
